...
// Kursunlar
    ...
    bullet1.src = 'Sprites/Projectiles/Bullets/bulletfire.png';
    const bullet2 = new Image();
    bullet2.src = 'Sprites/Projectiles/Bullets/bulletfire.png';
    const bullet3 = new Image();
    bullet3.src = 'Sprites/Projectiles/Bullets/bulletfire.png';
    ...
    class Projectiles {
        ...
        draw() {
            ctx.beginPath();
            ctx.drawImage(this.projectile , this.frameX * this.spriteWidth + 10, this.frameY * this.spriteHeight + 10,this.spriteWidth + 10, this.spriteHeight + 10, this.x, this.y, this.width, this.height);
        }
    }
...
// puan hiz ayari
            if (score != 0) {
                this.movement = this.speed + (score*0.004);
            }
        }
        ...
        draw() {
            ...
            ctx.font = '20px orbitron';
            ctx.fillText(Math.floor(this.health), this.x + 28, this.y + -5);
            if(this.enemyType === enemy1){ctx.drawImage(enemy1, this.frameX * this.spriteWidth, 0, this.spriteWidth, this.spriteHeight,
                this.x, this.y, this.width, this.height);
            }else if (this.enemyType === enemy2){ctx.drawImage(enemy2, this.frameX * this.spriteWidth, 0, this.spriteWidth, this.spriteHeight,
                this.x, this.y, this.width, this.height);
            }else if (this.enemyType === boss1){ctx.drawImage(boss1, this.frameX * this.spriteWidth, 0, this.spriteWidth, this.spriteHeight,
                this.x, this.y, this.width, this.height);
            }
        }
        ...
        draw() {
            {
                ...
                if((this.amount === 20)){ctx.drawImage(resource1, this.frameX * this.spriteWidth, this.frameY * this.spriteHeight, this.spriteWidth, this.spriteHeight,
                    this.x, this.y, this.width, this.height);
                }else if(this.amount === 30){ctx.drawImage(resource2, this.frameX * this.spriteWidth, this.frameY * this.spriteHeight, this.spriteWidth, this.spriteHeight,
                    this.x, this.y, this.width, this.height);
                }else if(this.amount === 50){ctx.drawImage(resource3, this.frameX * this.spriteWidth, this.frameY * this.spriteHeight, this.spriteWidth, this.spriteHeight,
                    this.x, this.y, this.width, this.height);
                }
        }
    }
    ...
    function handleGameStatus() {
        ...
        if (gameOver) {
            if (score <= 10000) {
                ...
                create(' Benim skorum: ' + score + "#The Last Castle!" )    
            }
             else if (score >= 20000) {
